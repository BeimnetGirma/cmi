...
const DeleteEvent = ({ event, deleteEvent }: DeleteEventProps) => {
          ...
          <div>
            ...
            <div className="fixed inset-60 w-2/4 mx-auto flex items-center bg-black justify-center">
              ...
              <div className=" bg-white p-4 rounded-lg">
                ...
                <h1 className="text-slate-900 text-2xl relative ">Delete Event</h1>
                <hr className="relative" />
                <div className="relative mx-10 px-10">
                  <p className="text-red-600 text-l">Are you sure you want to delete ? This action cannot be undone. </p>
                </div>

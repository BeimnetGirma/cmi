...
type NewMagazineProps = {
  createMagazine: (magazine: Magazine) => void;
};

const NewMagazine = ({ createMagazine }: NewMagazineProps) => {
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    try {
      ...
      if (!response.ok) {
        stopLoading();
        toast.error("Failed to upload the magazine.", {
          duration: 3000,
      ...
      if (error instanceof Error) {
        toast.error("Failed to publish the magazine.", {
          duration: 3000,
        ...
        <div>
          ...
          <div className="fixed inset-60 w-2/4 mx-auto items-center bg-black justify-center">
            ...
            <div className=" bg-white p-4 rounded-lg">
              ...
              <h1 className="text-slate-900 text-3xl relative ">Add New Magazine</h1>

...
type EditMagazineProps = {
  magazine: Magazine;
  editMagazine: (magazine: Magazine) => void;
};
const EditMagazine = ({ magazine, editMagazine }: EditMagazineProps) => {
  const [isOpen, setIsOpen] = useState(false);
  const [title, setTitle] = useState(magazine.title);
  const [filePath, setFilePath] = useState(magazine.path);
          ...
          <div>
            ...
            <div className="fixed inset-60 w-2/4 mx-auto  items-center bg-black justify-center">
              ...
              <div className=" bg-white p-4 rounded-lg">
                ...
                <h1 className="text-slate-900 text-3xl relative ">Edit Magazine Details</h1>

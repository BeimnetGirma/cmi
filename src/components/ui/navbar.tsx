...
> = ({ services, executives, announcements, resourceTypes, params: { lng } }) => {
  ...
  return (
    <nav className="bg-shadedbg-main shadow-md z-50 px-4 sm:px-6 lg:px-8">
      <div className="flex flex-row w-full">
        <div className="flex justify-between items-center flex-1 min-w-0">
          ...
          <div className="flex items-center flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <Image src="/assets/imgs/logo-text.png" alt="Logo" width={320} height={380} className="w-3/4 md:w-full" />
            </Link>
          </div>
          ...
          {/* Desktop Menu */}
          <ul className="hidden lg:flex nav-lg:flex items-center gap-5 flex-wrap p-4">
            {navLinks.map((link) => (
              <li
                key={link.href}
        ...
        {/* Language */}
        <div className="hidden lg:flex flex-none justify-end items-start">

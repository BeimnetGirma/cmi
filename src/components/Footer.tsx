          ...
          <div className="flex flex-col items-center">
            <div>
              <a href="#" className="flex items-center space-x-2">
                <Image src="/assets/imgs/alt-logo.svg" alt="Logo" width={180} height={180} />
              </a>
            </div>
            ...
            <div className="w-1/2">
              ...
              <p className=" text-sm text-slate-300">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus et purus viverra, molestie magna nec, viverra nunc. Etiam molestie, tortor at convallis feugiat
              </p>
            </div>
          </div>

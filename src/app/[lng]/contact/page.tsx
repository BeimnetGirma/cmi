    ...
    <div className="">
        ...
        <div className="flex flex-col items-center justify-center p-10 w-1/2 m-auto 2">
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="p-4 flex flex-col items-center justify-center ">
              ...
              <p className="justify-center text-center text-sm">In front of Bole Printing Press, Hansem Office Park, 5-7th floor</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-50">
        <div className="flex flex-col items-center justify-center py-10 w-3/4 m-auto 2">
          <div className="grid grid-cols-1 md:grid-cols-1 px-20">

  ...
  return (
    <div className="pt-8 mt-20">
      ...
      <div className="p-2 flex flex-col items-center justify-center">
        <h2 className="text-xl font-bold text-primary-main text-center pt-10">CONTACT US</h2>
      ...
      <div className="p-2 flex flex-col items-center justify-center">
        <h2 className="text-xl font-bold text-primary-main text-center pt-10">FOLLOW US ON</h2>
        <div className="flex justify-center ">
          <p className="text-sm text-slate-800 text-center pt-5">Here you will find our contact information</p>
        </div>
        <div className="flex flex-col items-center justify-center p-10 w-1/2 m-auto 2">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="p-4 px-10 flex flex-col items-center justify-center border-r-2">
              ...
              <p className="justify-center text-center text-sm">solutions_salus_stillas</p>
            </div>
            <div className="p-4 px-10 flex flex-col items-center justify-center border-r-2">
              <div className="flex items-center mb-2 mt-5">
                <div className="w-10 h-10 flex items-center justify-center rounded-full bg-purple-100 mr-2">
              ...
              <p className="justify-center text-center text-sm">salus_stillas</p>
            </div>
            <div className="p-4 px-10 flex flex-col items-center justify-center ">
              ...
              <p className="justify-center text-center text-sm">salus_stillas_solutions</p>
            </div>
          </div>
        </div>
      </div>
